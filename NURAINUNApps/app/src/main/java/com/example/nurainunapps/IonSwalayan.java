    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if(pilihan.equals("Call Center")) {
                String nomortel="tel:0823-4636-6011";
                a=new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));

            }  else if(pilihan.equals("SMS Center")) {
                String smsText="Nurainun/P";
                a=new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:083193889819"));
                a.putExtra("sms_body",smsText);

            } else if(pilihan.equals("Driving Direction")) {
                String lokasisupermarket="https://www.google.com/maps/dir/2.354282,100.092048/ion+swalayan/@1.4292829,99.434107,8z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x31d5ae5db43146b5:0xa1068817b2e5e8!2m2!1d101.4866057!2d0.4946415";
