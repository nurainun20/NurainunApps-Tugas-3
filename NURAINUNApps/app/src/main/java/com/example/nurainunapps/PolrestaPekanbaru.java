    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if(pilihan.equals("Call Center")) {
                String nomortel="tel:0831-9072-3881";
                a=new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));

            }  else if(pilihan.equals("SMS Center")) {
                String smsText="Nurainun/P";
                a=new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:081267890006"));
                a.putExtra("sms_body",smsText);

            } else if(pilihan.equals("Driving Direction")) {
                String lokasipolsek="https://www.google.com/maps/dir/2.354282,100.092048/polresta+pekanbaru/@1.4292829,99.4174927,8z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x31d5ac0e5898027d:0xf09dd0c61bcb93e3!2m2!1d101.4433152!2d0.5335484";
