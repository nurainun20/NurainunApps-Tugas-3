    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if(pilihan.equals("Call Center")) {
                String nomortel="tel:0761-74532762";
                a=new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));

            }  else if(pilihan.equals("SMS Center")) {
                String smsText="Nurainun/P";
                a=new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:082277615032"));
                a.putExtra("sms_body",smsText);

            } else if(pilihan.equals("Driving Direction")) {
                String lokasirs="https://www.google.com/maps/dir/2.354282,100.092048/rs+jiwa+tampan/@1.416519,99.4174927,8z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x31d5a85be66bb65b:0x843e44bbd84eb38d!2m2!1d101.3825906!2d0.4649441";
